...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'ML_projects.const_vals': {},
            ...
            'ML_projects.explore_data': { 'ML_projects.explore_data.DataExploration': ( 'data_exploration.html#dataexploration',
                                                                                        'ML_projects/explore_data.py'),
                                          'ML_projects.explore_data.DataExploration.__init__': ( 'data_exploration.html#dataexploration.__init__',
                                                                                                 'ML_projects/explore_data.py'),
                                          'ML_projects.explore_data.DataExploration._generate_histogram_': ( 'data_exploration.html#dataexploration._generate_histogram_',
                                                                                                             'ML_projects/explore_data.py'),
                                          'ML_projects.explore_data.DataExploration._scatter_plots_gt_': ( 'data_exploration.html#dataexploration._scatter_plots_gt_',
                                                                                                           'ML_projects/explore_data.py')},
